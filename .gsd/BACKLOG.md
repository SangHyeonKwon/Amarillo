...
> #1 임계·율 집계 알림은 **M005 S14로 출하 완료** → `.gsd/S14-SUMMARY.md` /
> ROADMAP M005 섹션 참조. 본 카탈로그에서는 제거.

### 1. S11.1 — ABI args 디코딩 + root_cause.input 디코드
...
| # | 항목 | 가치 | 크기 | 페르소나 |
|---|------|------|------|---------|
| 1 | DNS-time SSRF | ★★ (보안 잔여) | 작-중 | 보안 운영자 |
| 2 | S15 봇 라벨 (M005 후속) | ★★ (페르소나 깊이) | 중 | 봇 운영자 |
| 3 | S16 봇 운영자 cookbook | ★★ (페르소나 완결) | 작 | 봇 운영자 |
| 4 | S11.1 ABI args 디코딩 | ★★ (진단 깊이) | 중-큼 | dApp 개발자 |
| 5 | S12.1 enum 세분화 | ★★ (정밀도) | 큼 | dApp 개발자 |
| 6 | S13.1 패키지 게시 | ★ (운영성) | 작/중 | dApp 개발자 |
| 7 | Pools/Traders FE | ☆ (D001 정신) | 작 | 데모 사용자 |

**해석**: M005의 첫 슬라이스 S14가 출하됐으니 자연 후속은 S15/S16(봇 운영자
페르소나 완결) 또는 단독 보안 잔여(#1 DNS-rebind). 4·5번은 dApp 개발자 깊이
추가, 6번은 첫 사용자 요청 후, 7번은 영영 안 해도 무방(D001). S15/S16은
ROADMAP M005 섹션에서도 추적 — BACKLOG는 *결정 보조 메타데이터* (가치/리스크/
크기 등)를 담고 ROADMAP은 *마일스톤 진행* 을 담음.
